...
const config = {
  ...
  theme: {
    ...
    extend: {
      ...
      dropShadow: {
        glow: ['0 0px 10px rgba(255, 255, 255, 0.5)', '0 0px 10px rgba(255, 255,255, 0.2)'],
      },
    },
  },
  plugins: [
      ...
      matchUtilities(
        {
          'bg-grid': (value: any) => ({
            backgroundImage: `url("${svgToDataUri(
              `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="32" height="32" fill="none" stroke="${value}" stroke-width="1"><path d="M0 0 32 0 32 32 0 32 0 0"/></svg>`
            )}")`,
          }),
          'bg-grid-medium': (value: any) => ({
            backgroundImage: `url("${svgToDataUri(
